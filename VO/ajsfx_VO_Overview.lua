...
-- @author ajsfx
-- @version 0.15.1
-- @changelog Bugfix on 0.15. With a custom scratch folder set in Settings, a failed project lookup used to name that folder after the error message itself -- REAPER got a directory called "unsaved-attempttocallanilvaluefieldEnumProjects" instead of a scratch folder. A lookup that fails now names nothing, and the unsaved-project fallback is a stable name again. No behaviour changes anywhere else in 0.15.
